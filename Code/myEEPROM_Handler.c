...
#define S_FUNCTION_NAME myEEPROM_Handler
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          8
/* Input Port  0 */
#define IN_PORT_0_NAME      passwordIn
...
/* Input Port  2 */
#define IN_PORT_2_NAME      oldReadReq
...
/* Input Port  3 */
#define IN_PORT_3_NAME      clearReq
...
/* Input Port  4 */
#define IN_PORT_4_NAME      oldClearReq
...
/* Input Port  5 */
#define IN_PORT_5_NAME      writeReq
...
/* Input Port  6 */
#define IN_PORT_6_NAME      oldWriteReq
...
/* Input Port  7 */
#define IN_PORT_7_NAME      passAssignedIn
#define INPUT_7_WIDTH       1
#define INPUT_DIMS_7_COL    1
#define INPUT_7_DTYPE       boolean_T
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      passwordOut
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      readComplete
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      writeComplete
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      clearComplete
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      passAssignedOut
...
{
    const uint8_T   *passwordIn  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const boolean_T   *readReq  = (const boolean_T*) ssGetInputPortSignal(S,1);
    const boolean_T   *oldReadReq  = (const boolean_T*) ssGetInputPortSignal(S,2);
    const boolean_T   *clearReq  = (const boolean_T*) ssGetInputPortSignal(S,3);
    const boolean_T   *oldClearReq  = (const boolean_T*) ssGetInputPortSignal(S,4);
    const boolean_T   *writeReq  = (const boolean_T*) ssGetInputPortSignal(S,5);
    const boolean_T   *oldWriteReq  = (const boolean_T*) ssGetInputPortSignal(S,6);
    const boolean_T   *passAssignedIn  = (const boolean_T*) ssGetInputPortSignal(S,7);
    uint8_T        *passwordOut  = (uint8_T *)ssGetOutputPortRealSignal(S,0);
    boolean_T        *readComplete  = (boolean_T *)ssGetOutputPortRealSignal(S,1);
    boolean_T        *writeComplete  = (boolean_T *)ssGetOutputPortRealSignal(S,2);
    boolean_T        *clearComplete  = (boolean_T *)ssGetOutputPortRealSignal(S,3);
    boolean_T        *passAssignedOut  = (boolean_T *)ssGetOutputPortRealSignal(S,4);

    myEEPROM_Handler_Outputs_wrapper(passwordIn, readReq, oldReadReq, clearReq, oldClearReq, writeReq, oldWriteReq, passAssignedIn, passwordOut, readComplete, writeComplete, clearComplete, passAssignedOut);
