...
#define S_FUNCTION_NAME Button_Lib
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      RFInput
...
{
    boolean_T        *RFInput  = (boolean_T *)ssGetOutputPortRealSignal(S,0);
    boolean_T        *passSw  = (boolean_T *)ssGetOutputPortRealSignal(S,1);

    Button_Lib_Outputs_wrapper(RFInput, passSw);
