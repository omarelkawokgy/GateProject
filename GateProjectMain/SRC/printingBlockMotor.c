 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Oct 21 15:42:58 2017
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME printingBlockMotor
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          6
/* Input Port  0 */
#define IN_PORT_0_NAME      leftMotor
...
/* Input Port  1 */
#define IN_PORT_1_NAME      rightMotor
...
/* Input Port  2 */
#define IN_PORT_2_NAME      leftCurr
...
/* Input Port  3 */
#define IN_PORT_3_NAME      rightCurr
...
/* Input Port  4 */
#define IN_PORT_4_NAME      rightCurrRaw
...
/* Input Port  5 */
#define IN_PORT_5_NAME      leftCurrRaw
...
extern void printingBlockMotor_Outputs_wrapper(const uint8_T *leftMotor,
...
{
    const uint8_T   *leftMotor  = (const uint8_T*) ssGetInputPortSignal(S,0);
    const uint8_T   *rightMotor  = (const uint8_T*) ssGetInputPortSignal(S,1);
    const uint8_T   *leftCurr  = (const uint8_T*) ssGetInputPortSignal(S,2);
    const uint8_T   *rightCurr  = (const uint8_T*) ssGetInputPortSignal(S,3);
    const uint16_T   *rightCurrRaw  = (const uint16_T*) ssGetInputPortSignal(S,4);
    const uint16_T   *leftCurrRaw  = (const uint16_T*) ssGetInputPortSignal(S,5);

    printingBlockMotor_Outputs_wrapper(leftMotor, rightMotor, leftCurr, rightCurr, rightCurrRaw, leftCurrRaw);
